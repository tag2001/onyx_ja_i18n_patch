...
| `0002-feat-web-localize-chat-and-agents-screens.patch` | チャット初期画面と Agents 一覧画面の追加日本語化パッチ |
...
- チャット初期画面、入力 placeholder、Agents 一覧画面、Agents フィルタ、フッター文言を追加日本語化
...
既に `0001` を適用済みの Onyx v4.1.3 環境では、追加分として `0002` だけを適用できます。
...
git am /home/ubuntu/onyx_ja_i18n_patch/0002-feat-web-localize-chat-and-agents-screens.patch
```
